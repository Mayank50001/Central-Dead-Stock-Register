...
SECRET_KEY = "django-insecure-i)&p)chc_3ash6zqxwt(&(@xv*v$q06tk+5ctg%mqht@8sqqai"
...
TEMPLATES = [
    {
        ...
        'APP_DIRS': True,  # Allow Django to find app-specific templates automatically
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "static"),  # Add this line to specify static files folder
]
